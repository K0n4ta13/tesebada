...
Representan las ventas del sistema OLTP.
...
Son las tablas del almacén de datos; representan las funciones de agregación, la vista materializada y las tablas auxiliares.
...
Esta tabla representa la versión actual y su estado. Además, se define una función que devuelve la versión activa y actualiza el campo de activación en caso de ser necesario.
...
Actualiza las tablas del almacén de datos con base en la tabla Ventas. Por cada operación que modifique dicha tabla, refleja los cambios en las tablas del almacén de datos y actualiza la vista materializada cuando sea necesario.
...
= Trigger Tabla VentasUSA

Actualiza las tablas del almacén de datos con base en la tabla VentasUSA. Por cada operación que modifique dicha tabla, refleja los cambios en las tablas del almacén de datos y actualiza la vista materializada cuando sea necesario.
...
Esta función actualiza la vista materializada con base en las tablas del almacén de datos y es llamada desde los triggers de las tablas de ventas.
...
= Función para acceder a la vista materializada

Esta función permite recuperar los datos de una versión específica de la vista materializada, cerrando la versión activa en caso de ser necesario.
